                ...
                <div>
                    ...
                    <p class="text-sm mt-2 text-gray-700">
                        ...
                        <button form="send-verification"
                                class="underline text-sm text-teal-600 hover:text-teal-700 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500">
                            {{ __('Fai clic qui per inviare nuovamente l\'email di verifica.') }}
                        </button>
